...
The user lands on a PayMongo-hosted checkout page at `checkout.paymongo.com/{session_id}`.

- The order summary is shown on the left (item, subtotal, fees)
- The payment panel is on the right
...
### 3. Payment Confirmation (GCash App)
...
### 4. PayMongo Checkout Success Screen
...
### 5. PayMongo Dashboard — Payments List
...
### 6. PayMongo Dashboard — Payment Detail & Fee Breakdown
